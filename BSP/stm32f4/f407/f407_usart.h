/**
 * @file f407_usart.h
 * @brief STM32F407 系列通用 USART 驱动头文件
...
extern "C"
{
    ...
    typedef enum
    {
        F407_USART_WORDLEN_8B = 0,
        F407_USART_WORDLEN_9B = 1
    } f407_usart_wordlen_t;
    ...
    typedef enum
    {
        F407_USART_STOPBITS_1 = 0,
        F407_USART_STOPBITS_0_5 = 1,
        F407_USART_STOPBITS_2 = 2,
        F407_USART_STOPBITS_1_5 = 3
    } f407_usart_stopbits_t;
    ...
    typedef enum
    {
        F407_USART_PARITY_NONE = 0,
        F407_USART_PARITY_EVEN = 1,
        F407_USART_PARITY_ODD = 2
    } f407_usart_parity_t;
    ...
    typedef enum
    {
        F407_USART_MODE_RX = 0x01,
        F407_USART_MODE_TX = 0x02,
        F407_USART_MODE_TX_RX = 0x03
    } f407_usart_mode_t;
    ...
    typedef enum
    {
        F407_USART_HWFLOW_NONE = 0,
        F407_USART_HWFLOW_RTS = 1,
        F407_USART_HWFLOW_CTS = 2,
        F407_USART_HWFLOW_RTS_CTS = 3
    } f407_usart_hwflow_t;
    ...
    typedef enum
    {
        F407_USART1_PINS_PA9_PA10 = 0, // USART1: PA9(TX), PA10(RX)
        F407_USART1_PINS_PB6_PB7,      // USART1: PB6(TX), PB7(RX)
        F407_USART2_PINS_PA2_PA3,      // USART2: PA2(TX), PA3(RX)
        F407_USART2_PINS_PD5_PD6,      // USART2: PD5(TX), PD6(RX)
        F407_USART3_PINS_PB10_PB11,    // USART3: PB10(TX), PB11(RX)
        F407_USART3_PINS_PC10_PC11,    // USART3: PC10(TX), PC11(RX)
        F407_USART3_PINS_PD8_PD9,      // USART3: PD8(TX), PD9(RX)
        F407_UART4_PINS_PA0_PA1,       // UART4: PA0(TX), PA1(RX)
        F407_UART4_PINS_PC10_PC11,     // UART4: PC10(TX), PC11(RX)
        F407_UART5_PINS_PC12_PD2,      // UART5: PC12(TX), PD2(RX)
        F407_USART6_PINS_PC6_PC7       // USART6: PC6(TX), PC7(RX)
    } f407_usart_pinmap_t;
    ...
    typedef struct
    {
        f407_usart_t usart;             // USART编号
        uint32_t baudrate;              // 波特率
        f407_usart_wordlen_t wordlen;   // 数据位
        f407_usart_stopbits_t stopbits; // 停止位
        f407_usart_parity_t parity;     // 校验位
        f407_usart_mode_t mode;         // 工作模式
        f407_usart_hwflow_t hwflow;     // 硬件流控
        f407_usart_pinmap_t pinmap;     // 引脚映射
    } f407_usart_config_t;

    /**
     * @brief USART接收回调函数类型
     */
    typedef void (*f407_usart_rx_callback_t)(uint8_t data);
    ...
    typedef struct
    {
        ...
        f407_usart_config_t config;           // 配置信息
        bool initialized;                     // 初始化标志
        f407_usart_rx_callback_t rx_callback; // 接收回调
    ...
    /* USART时钟频率 */
#define F407_USART1_CLK 84000000UL // APB2时钟
#define F407_USART6_CLK 84000000UL // APB2时钟
#define F407_USART2_CLK 42000000UL // APB1时钟
#define F407_USART3_CLK 42000000UL // APB1时钟
#define F407_UART4_CLK 42000000UL  // APB1时钟
#define F407_UART5_CLK 42000000UL  // APB1时钟

    /* 常用波特率 */
#define F407_USART_BAUD_9600 9600
#define F407_USART_BAUD_19200 19200
#define F407_USART_BAUD_38400 38400
#define F407_USART_BAUD_57600 57600
#define F407_USART_BAUD_115200 115200
#define F407_USART_BAUD_230400 230400
#define F407_USART_BAUD_460800 460800
#define F407_USART_BAUD_921600 921600

    /* 超时时间 */
#define F407_USART_TIMEOUT 10000
